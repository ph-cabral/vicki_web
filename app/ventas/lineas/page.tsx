...
// ──────────────────────────────────────────────────────────────────────────────
// 2026-09-23 — VISTA DE LÍNEAS (/ventas/lineas, en el menú "Líneas"). Antes
// vivía en /ventas/bulones: esa ruta quedó como redirect acá y los permisos /
// accesos guardados con el href viejo se traducen solos (LEGACY_VIEW_HREFS en
// lib/auth/modules.ts).
                  ...
                  <thead className="bg-[#1A1A1A] text-zinc-400">
                    <tr>
                      ...
                      <th className="px-3 py-2 font-medium text-right whitespace-nowrap border-l border-zinc-800 text-yellow-400/80">
                        {/* El título es el TOTAL de la columna (mismo número
                            que el pie, suma de TODAS las filas) y el mes
                            queda de subtítulo — igual que /ventas/vendedor. */}
